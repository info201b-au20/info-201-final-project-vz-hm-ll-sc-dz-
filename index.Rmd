...
This chart demonstrates the differences in personal freedoms in establishing one’s own identity and to have intimate and familial relationships with others across different
regions.
...
<br>
<br>
From the chart above, we could observe that regions like Sub-Saharan Africa, South Asia, and Middle East & North Africa, which mainly consist of countries that are considered less "developed", exhibit significantly lower mean index for three or more of the categories considered.
<br>
<br>
...
This plot shows a geographical representation of the freedom index values across countries. Yellow indicates low freedom and blue indicates a higher level of freedom. The white represents countries without values. From the graphic, it is clear that countries that are generally considered more "developed" also have a higher level of human freedom.
<br>
<br>
...
This plot shows the relationship of personal and economic freedom in 2017. They're color coded by region. Middle East & North Africa have the lowest personal and economic freedoms, and Africa as a whole is the region with the most widespread freedoms. Clumped heavily at the top of the scatter-plot is Western Europe, where personal and economic freedoms are the highest.
